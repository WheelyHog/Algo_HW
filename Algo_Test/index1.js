...
// Для заданной длины стены w и полок двух длин m и n найдите количество используемых полок каждого типа и
//  оставшееся пустое пространство в оптимальном решении, чтобы пустое пространство было минимальным.
// Большая из двух полок дешевле, поэтому она предпочтительнее.Однако стоимость второстепенна,
// и первоочередной задачей является минимизация пустого пространства на стене.
